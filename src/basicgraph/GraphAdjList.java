...
public class GraphAdjList extends Graph {
    ...
    public List<Integer> getDistance2(int v) {
        ...
        LinkedList<Integer> queue = new LinkedList<>(getNeighbors(v));
        List<Integer> neighboursTwoHops = new ArrayList<>();
        Iterator<Integer> queueIterator = queue.iterator();

        while (queueIterator.hasNext()) {
            neighboursTwoHops.addAll(getNeighbors(queueIterator.next()));
        }

        return neighboursTwoHops;
    }
